  ...
  return (
    <div className="App">
      ...
      {isCardVisible && (
        ...
        {/* Section for displaying the usage count */}
        <div>
          <div
            style={{
              width: "100%",
          ...
          >
            ...
            >
              <span style={{ color: "white", padding: "0 5px" }}>
                {`จำนวนผู้ใช้โค้ดเชิญ: ${usageCount} (${percentage.toFixed(1)}%)`}
              </span>
            </div>
        ...
        {/* Section for copying the invite code */}
        <div>
          {inviteCode && (
            <div className="input-wrapper">
              <p className="input-text">
                <strong id="inviteCode">{inviteCode}</strong>
              </p>
              <button onClick={copyToClipboard} className="Subscribe-btn">
        ...
        <br/>
        {/* Section for entering and checking the invite code */}
        <div>
          <div className="input-wrapper">
            <input
              type="text"
            ...
            />
            <button onClick={checkInviteCode} className="Subscribe-btn">
            <svg class="Subscribe-svg w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
...
{isLoading ? (
        ...
        <div>
          {inviteCode && (
            <div className="input-wrapper">
              <p className="input-text">
              <strong id="inviteCode">
                {inviteCode.length > 10 ? `${inviteCode.slice(0, 14)}...` : inviteCode}
              </strong>
              </p>
              <button onClick={copyToClipboard} className="Subscribe-btn">
              <svg class="Subscribe-svg w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
